...
# Load .env file (should be in the same directory as manage.py)
load_dotenv()
import environ
env = environ.Env()
# reading .env file
...
# For development, you can set EMAIL_BACKEND to console:
# if DEBUG:
#     EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
...
POSTMAN_DISALLOW_ANONYMOUS = os.environ.get('POSTMAN_DISALLOW_ANONYMOUS', 'True') == 'True'
